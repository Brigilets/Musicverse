    ...
    return(
        <div className="main">
            ...
            <Card inverse className="container-fluid mainpage">
                ...
                <CardImgOverlay>
                    <CardTitle tag="h3" className="pt-1 header"> ABOUT MUSICVERSE</CardTitle>
                    <CardText className="text">
                        <p>Musicverse was created by music lovers to musiclovers! We invite you to join our vision of paradise as an electronic music lovers. We guarantee you'll be taken to another dimetion by the great artist we invite to perform in MUSICVERSE along with our guests who are like-minded like you. </p>
